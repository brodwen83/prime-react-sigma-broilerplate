        ...
        <div className="p-col-12">
          <div className="card docs">
            ...
            <p>
              ...
              started extract the contents of the zip bundle and install the
...
`}
            ...
            <p>
              ...
              application using the Avalon template.
            </p>
            <pre>
              {`npm start
`}
...
`}
            ...
            <p>
              ...
              layout.scss file under src/layout folder. Saving the changes will
              be reflected instantly at your browser.
            </p>
...
`}
            ...
            <h1>Dark Menu</h1>
            <p>
              Default color scheme of menu is light and alternative dark mode
              can be activated by adding <i>dark-sidebar'</i> style class to the
              sidebar element.
            </p>
            <pre>
            ...
            <h1>Grid CSS</h1>
            <p>
              Sigma uses PrimeReact Grid CSS (p-col-*) throughout the samples,
              although any grid library can be used we suggest using Grid CSS as
              your layout framework as it is well tested and supported by
              PrimeReact. Grid CSS is available inside primereact.min.css.
            </p>
            <h1>Customizing Styles</h1>
            <p>
              It is suggested to write your customizations in <i>App.css</i>{' '}
              file instead of adding them to the scss files under sass folders
              to avoid maintenance issues after an update.
            </p>
          </div>
        </div>
      </div>
